...
![This image shows the difference between the old popup palette and the new one on 4k display with 200% UI scaling. Note that it also shows a new button and custom UI text.](images/popup_palette_comparison.png) Agata Cacko 改进了 Krita 的 HiDPI 显示效果 ([BUG:411118](https://bugs.kde.org/show_bug.cgi?id=411118))，包括以下方面：
