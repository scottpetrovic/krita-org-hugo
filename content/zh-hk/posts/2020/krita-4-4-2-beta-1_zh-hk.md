...
\[caption id="attachment\_11416" align="aligncenter" width="1024"\][![網狀漸變](images/Handles-meshgradient-1024x554.png "網狀漸變")](https://krita.org/wp-content/uploads/2020/12/Handles-meshgradient.png) 網狀漸變\[/caption\]

### 網狀變形

\[caption id="attachment\_11432" align="aligncenter" width="1168"\][![網狀變形嘅用法](images/krita_4_4_2_mesh_gradients.png "網狀變形嘅用法")](https://krita.org/wp-content/uploads/2020/12/krita_4_4_2_mesh_gradients.png) 網狀變形容許作出複雜嘅曲線變形效果，例如係圖中半圓凸出嚟嘅窗框。依項功能可以大幅提升製作概念藝術嘅效率。\[/caption\]
...
\[caption id="attachment\_11434" align="aligncenter" width="1383"\][![漸變填充圖層同新版漸變編輯工具](images/krita_4_4_2_new_gradient_editor_and_fill_layer.png "漸變填充圖層同新版漸變編輯工具")](https://krita.org/wp-content/uploads/2020/12/krita_4_4_2_new_gradient_editor_and_fill_layer.png) 正在使用漸變填充圖層同新版漸變編輯工具。\[/caption\]
...
\[caption id="attachment\_11435" align="aligncenter" width="1528"\][![經半調濾鏡處理嘅 Krita 啟動畫面](images/krita_4_4_2_halftone_filter.png "經半調濾鏡處理嘅 Krita 啟動畫面")](https://krita.org/wp-content/uploads/2020/12/krita_4_4_2_halftone_filter.png) 新的半調濾鏡可以分別處理獨立色彩通道，可以用嚟產生懷舊效果，甚至係用於印刷。\[/caption\]
...
[![](images/wraparound_button.png)](https://krita.org/wp-content/uploads/2020/12/wraparound_button.png) 唔好再㩒錯喇，好唔好？

### 改進高解像度縮放 (HiDPI) 嘅支援

![喺 4K 顯示器 200% 介面縮放上，舊版同新版入面浮動畫具板嘅分別。依幅圖亦展示咗一個新按鈕同自訂介面字型。左：舊版 / 右：新版](images/popup_palette_comparison.png "喺 4K 顯示器 200% 介面縮放上，舊版同新版入面浮動畫具板嘅分別。依幅圖亦展示咗一個新按鈕同自訂介面字型。左：舊版 / 右：新版") Agata Cacko 改進咗以下顯示嘅 HiDPI 畫面效果 ([BUG:411118](https://bugs.kde.org/show_bug.cgi?id=411118))：
